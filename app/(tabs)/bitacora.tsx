...
const EMOCIONES_POR_SECCION: { [key: string]: { nombre: string; imagen: any }[] } = {
    escuela: [
        ...
        { nombre: 'Diversión', imagen: require('../../assets/images/Diversion.png') },
    ],
    salud: [
        { nombre: 'Vergüenza', imagen: require('../../assets/images/Verguenza.png') },
    ...
    cultura: [
        { nombre: 'Vergüenza', imagen: require('../../assets/images/Verguenza.png') },
        { nombre: 'Emociones encontradas', imagen: require('../../assets/images/EmocionesEncontradas.png') },
        { nombre: 'Confusión', imagen: require('../../assets/images/Confusion.png') },
        { nombre: 'Felicidad', imagen: require('../../assets/images/Felicidad.png') },
    ],
    seguridad: [
        { nombre: 'Vergüenza', imagen: require('../../assets/images/Verguenza.png') },
